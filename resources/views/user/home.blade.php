    ...
    <section id="product-area" data-scroll-index="3">
        <div class="container">
            ...
            <div class="row">
                ...
                @foreach ($getAllProducts as $showAllProducts)
                    <div class="col-md-6">
                        <div class="product-single row">
                            <div class="product-img text-center col-lg-6">
                                <img src="images/{{ $showAllProducts->image }}" class="img-fluid" alt="Image">
                            </div>
                            <div class="product-cont col-lg-6">
                                <h4>{{ $showAllProducts->name }}</h4>
                                {!! $showAllProducts->description !!}
                                {{-- THIS TELLS THE ENGINE TO SEE THE DESCRIPTIONS IN HTML FORM INSTEAD OF IT SEEING THEM AS DUMMY TEXTS --}}
                                <ul>
                                ...
                                <h3>${{ $showAllProducts->sales_price }}
                                    <del><sup>${{ $showAllProducts->price }}</sup></del>
                                </h3>

                                <add-to-cart-button :product="{{ $showAllProducts }}" />
